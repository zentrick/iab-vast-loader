// flow-typed signature: 8ecb01da08c708bfc429a63dd22d3cdd
// flow-typed version: 201cfddff4/rxjs_v5.0.x/flow_>=v0.34.x
...
declare class rxjs$Observable<+T> {
  ...
  catch<U>(selector: (err: any, caught: rxjs$Observable<T>) => rxjs$Observable<U>): rxjs$Observable<U | T>;
  ...
  static ajax(urlOrRequest: string | AjaxRequest): rxjs$Observable<AjaxResponse>;
